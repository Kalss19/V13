...
const creator = ["𝙇𝙚𝙭𝙭𝙮 𝙊𝙛𝙛𝙞𝙘𝙞𝙖𝙡"]
const yt = ["https://youtube.com/c/LEX4YOUU"]
...
nana.sendMessage(from, log, image, { quoted: mek, caption: 'Logo By Lexxy Official' })
break
case 'artinama':
if (isBanned)return reply(mess.banned)
reply(mess.wait)
...
nf =`━➤ 「 𝙄𝙉𝙁𝙊 𝘿𝙀𝙑 」
✍️ 𝙈𝙖𝙙𝙚 𝙞𝙣 𝘽𝙮 𝙇𝙚𝙭𝙭𝙮 𝙊𝙛𝙛𝙞𝙘𝙞𝙖𝙡
🌟 𝙎𝙘𝙧𝙞𝙥𝙩 𝙑𝙚𝙧𝙨𝙞𝙤𝙣 : 10.0
📈 𝙇𝙖𝙨𝙩 𝙐𝙥𝙙𝙖𝙩𝙚 : 1.0
📃 𝙇𝙞𝙣𝙠 𝙎𝙘 : https://youtu.be/DN42naRJ6FE

📦 𝙂𝙧𝙤𝙪𝙥 1 :
https://chat.whatsapp.com/IQdenO0L2R0AgXWoWzssit
📦 𝙂𝙧𝙤𝙪𝙥 2 :
https://chat.whatsapp.com/CNwZkO2NhV76sP6NCX6i8A
...
sendKontak(from, `6282279915237`, `Developer Bot`)
